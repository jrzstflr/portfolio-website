  ...
  return (
    <div className='text-black flex flex-col-reverse md:flex-row justify-center items-center py-10 px-5 sm:px-10 lg:px-40 bg-gradient-to-t from-white to-yellow-50'>
      <div className='w-full md:w-1/2 mb-10 text-center md:text-left'>
        ...
        <p className='text-sm md:text-lg lg:text-2xl tracking-tighter'>a passionate aspiring Junior Programmer with a knack for solving problems and creating efficient solutions through coding. I’m currently advancing my knowledge and skills as an Associate in Computer Technology student at Clark College of Science and Technology.

With a solid foundation in logical thinking and programming basics, I’m eager to contribute to projects that challenge me to grow and improve. I pride myself on my willingness to learn and my dedication to delivering quality work in everything I do.</p>
